var PortraitMain = function(game){
};

PortraitMain.prototype = {
    g_isMaxLimit:false,
    g_nick: "",
    g_statusBg:null,
    labels: {
    ...
    create: function() {
        ...
        selectedChipId = 0;
        tableItem = [
            {x:45,  y:820, key:'placeChips', type:'1', angle: 9},
            {x:140, y:840, key:'placeChips', type:'2', angle: 6},
            {x:235, y:850, key:'placeChips', type:'3', angle: 3},
            {x:330, y:860, key:'placeChips', type:'4', angle: 0},
            {x:425, y:850, key:'placeChips', type:'5', angle: -3},
            {x:520, y:840, key:'placeChips', type:'6', angle: -6},
            {x:615, y:820, key:'placeChips', type:'7', angle: -9},
        ];
        ...
        this.labels.userName = this.add.text(5, gameFrameH-120, '', {
        ...
        this.labels.userBalance = createTextLbl(self, {
            ...
            x: bottomBalansLabel.x + bottomBalansLabel.width + 10,
            y: bottomBalansLabel.y,
            font: "ProximaNova",
            size: 26,
            color: "#e4a345",
            centered: false,
        ...
        this.buttons.provably = this.add.button(gameFrame.x + 20, gameFrame.y + 650, 'btnBg', function () {
        ...
        this.buttons.cashierBtn = this.add.button(gameFrameW - 34, gameFrameH - 126, 'cashin', function () {
            $.client.cashier();
        }, this);
        ...
        this.buttons.undo = this.add.button(10, gameFrameH-60, 'btnBg', this.cancelLast, this, 1, 0);
        ...
        this.buttons.clearAll = this.add.button(200, gameFrameH-60, 'btnBg', this.cancelAll, this, 1, 0);
        ...
        this.buttons.newGame = this.add.button(10, gameFrameH-350, 'btnBg', this.newGame, this, 1, 0);
        ...
        this.buttons.repeat = this.add.button(10, gameFrameH-280, 'btnBg', this.repeatGame, this, 1, 0);
        ...
        this.buttons.deal = this.add.button(20, 500, 'gameBtnBg', this.actionDeal, this, 6, 0);
        ...
        this.dealerCardPlace = this.add.sprite(300, 580, 'dealerCardsPlace');
        this.dealerCardPlace.width = 173;
        frameGroup.add(this.dealerCardPlace);
        this.buttons.stand = this.add.button(20, 500, 'gameBtnBg', this.standBet, this, 7, 1);
        ...
        this.buttons.hit = this.add.button(165, 500, 'gameBtnBg', this.hitCard, this, 9, 3);
        ...
        this.buttons.doubles = this.add.button(310, 500, 'gameBtnBg', this.doubleBet, this, 8, 2);
        ...
        this.buttons.split = this.add.button(450, 500, 'gameBtnBg', this.splitCards, this, 10, 4);
        ...
        this.buttons.insurance = this.add.button(590, 500, 'gameBtnBg', this.insuranceBet, this, 11, 5);
        ...
        this.g_statusBg = this.add.sprite(0, gameFrameH - 210, 'statusBg', 2);
        this.g_statusBg.width = 750;
            ...
            if(this.chipCost.length > 0){
                for (var a = 0; a < this.chipCost.length; a++) {
                    if (a == selectedChipId || a == 0) {
                        chipsEl = chipsGroup.create(gameFrameW - 527 + (a * 84),  gameFrameH - 330, 'chips', a + 6);
                        selectedChip = {id: a, value: this.chipCost[a]};
                    } else {
                        chipsEl = chipsGroup.create(gameFrameW - 527 + (a * 84), gameFrameH - 330, 'chips', a);
                    }
    ...
    drawChip: function(par, sent){
        ...
        chip.chipClone = this.add.graphics(chipCoordinates.x + 10, chipCoordinates.y + 20, selectedChipsGroup);
    ...
    updateUserInfoText: function(id, text, status){
    	...
    	if(status == 'win'){
            this.labels.userMsgStatus[id+'_bg'].loadTexture('statusStake', 1);
    	}else if(status == 'push'){
    		this.labels.userMsgStatus[id+'_bg'].loadTexture('statusStake', 2);
    	}else{
        ...
        if (!Global.isModalShow) {
            if (Global.selectedLimitArray.length != 0) {
               ...
               // worldGroup.add(popupWinGroup);
                ...
                modalBoxBg.height = 1400;
                modalBoxBg.useHandCursor = false;
                popupWinGroup.addChild(modalBoxBg);
                limitBox = this.add.sprite(50, 600, 'limitsBg');
                popupWinGroup.addChild(limitBox);
                popupWinGroup.bringToTop('limitBox');
                ...
                if ($.client.UserData.Features && $.client.UserData.Features.rules) {
                    var rulesBtn = this.add.button(450, 610, 'btnBg', function () {
                        $.client.showRules();
                    }, this);
                    rulesBtn.height = 40;
   ...
   lightActivePosionChip:function(pos){
    ...
    showHistory: function(element) {
        ...
        if (!Global.isModalShow) {
            ...
            historyBox = this.add.sprite(250, 600, 'historyBg');
            ...
            function showRow(item, posX, posY) {
                ...
                if(item){
                    winnerText = self.add.text(posX, posY, item.winText, { font: "18px ProximaNova", fill: "#fff", align: "center" });
                    historyBox.addChild(winnerText);
                    amount = item.win % 1 == 0 ? parseFloat(item.win).toFixed(0) : parseFloat(item.win).toFixed(2);
                    betText = self.add.text(posX+160, posY, $.client.UserData.CurrencySign + amount, { font: "18px ProximaNova", fill: "#fff", align: "center" });
