...
BlackjackLoad.prototype = {
	preload: function() {
        ...
        this.load.image('landGameFrame', '../Client2/images/land_game_frame.png');
	...
	create: function () {
        ...
        window.matchMedia("(orientation: portrait)").addListener(function(m) {
            if(m.matches) {
                ...
                game.scale.refresh();
                game.state.start('PortraitMain', false, false, Global);
            }else {
                ...
                game.scale.setUserScale(SCALE, SCALE);
                game.scale.refresh();
                game.state.start('LandscapetMain', false, false, Global);
            }
        });
