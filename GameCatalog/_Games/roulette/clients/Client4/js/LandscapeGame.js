...
var gameFrame, winNum, placeHold, timer, dolly, wheelBg, wheel, ball, wheelGroup;
var _winNumUpdate, progressText, _videoFlagShow, isModalShow,isSubmiting;

var worldGroup = {}, tableGroup = {}, frenchGroup = {}, chipsGroup = {}, buttonGroup = {}, selectedChipsGroup = {},
    frameGroup = {}, footerGroup = {}, winTextGroup = {}, limitGroup = {}, msgGroup, msgTimeout;
;
var tableCell = {},  Dozen ={}, Column = {}, Orphelins = {}, Neighbors = {}, RouletteLandscapeGame = {};
var previousMsgType, winAmount = 0, lastChangeStatus, startGameBtn, provablyBtn, settingsBtn;
...
RouletteLandscapeGame.Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('table', '../Client3/images/pad_table.png');
        this.load.image('mainBtnBg', '../Client3/images/pad_game_btn_bg.png');
        this.load.image('frenchBets', '../Client3/images/french_bets.png');
        this.load.image('frenchBetsBtn', '../Client3/images/french_bets_btn.png');
        this.load.image('cell_select', '../Client3/images/cell_select.png');
        this.load.image('zero_cell_select', '../Client3/images/zero_cell_select.png');
        ...
        this.load.image('settingsBox', '../Client3/images/settings_form.png');
        ...
        this.load.image('limitsSelectorBg', '../Client3/images/limitsSelectorDesktop.png');
        ...
        this.load.spritesheet('checkBox', '../Client3/images/check_box.png', 72, 32);
        this.load.spritesheet('statusBg', '../Client3/images/status_bg.png', 1600, 61);
        this.load.spritesheet('icons', '../Client3/images/btn_icons.png', 40, 27);
        this.load.spritesheet('bottomBtnBg', '../Client3/images/pad_bottom_btn_bg.png', 173, 71);
        this.load.spritesheet('chips', '../Client3/images/chips.png', 85, 85);
...
RouletteLandscapeGame.MainMenu.prototype = {
    ...
    create: function() {
        ...
        var bottomBetLabel, balansLabel, winLabel,
             ...
             chipsEl, table, frenchBets;

        var spriteXY, spriteX, spriteY;
        var cancelLastBtn, cancelAllBetBtn, repeatBetBtn, gameIdLabel, dateTimeLabel, frenchBetsBtn;
        ...
        table = tableGroup.create(1160, 40, 'table');
        table.scale.set(1.15);
        frenchBets = this.add.sprite(50, 670, 'frenchBets');
        frenchBets.scale.set(1.06);
        ...
        cashierBtn = this.add.button(gameFrame.width - 55, gameFrame.height - 62, 'cashin', function () {
            $.client.cashier();
        }, this);
        ...
        tableStatus = this.add.sprite(58, 574, 'statusBg', 0);
        tableStatus.width = 1044;
        ...
        repeatBetBtn = this.add.button(560, 902, 'mainBtnBg', this.repeatBets, this);
        ...
        cancelAllBetBtn = this.add.button(710, 902, 'mainBtnBg', this.cancelAllBet, this);
        ...
        cancelLastBtn = this.add.button(900, 902, 'mainBtnBg', this.cancelLastBet, this);
        ...
        historyBtn = this.add.button(576, 977, 'bottomBtnBg', this.showHistory, this, 1, 1);
      ...
      /*this.add.sprite(historyBtn.x + 10, historyBtn.y + 22, 'icons', 1);*/
        ...
        statsBtn = this.add.button(250, 977, 'bottomBtnBg', this.getStatisticData, this, 1, 1);
        ...
        settingsBtn = this.add.button(741, 977, 'bottomBtnBg', function() {
        ...
        var startGameBtnBg = this.add.button(1164, 790, 'mainBtnBg', this.startGame, this);
        ...
        frameGroup.add(startGameBtn);
    
        for (var a = 0; a <= NUM_DIB; a++) {
            if (a == selectedChipId) {
                chipsEl = chipsGroup.create(gameFrame.width - 527 + (a * 84), 885, 'chips', a + 6);
            } else {
                chipsEl = chipsGroup.create(gameFrame.width - 527 + (a * 84), 885, 'chips', a);
            }
        ...
        for (var i = 0; i < TABLE_COLS; i++) {
            for (var j = 0; j < TABLE_ROWS; j++) {
                ...
                tableCell[cellName] = tableGroup.create(table.x + 164 + i * (DIB_WIDTH + DIB_SPASE), table.y + 73 + j * (DIB_HEIGHT + DIB_SPASE), 'cell_select');
                ...
                spriteX = tableGroup.create(table.x + 157 + i * (DIB_WIDTH + DIB_SPASE), table.y + 75 + j * (DIB_HEIGHT + DIB_SPASE), 'cell_select');
                spriteX.name = 'lineY_' + i.toString() + '_' + j.toString();
                spriteX.bet_name = 'lineY_' + i.toString() + '_' + j.toString();;
                spriteX.alpha = 0;
                spriteX.inputEnabled = true;
                spriteX.width = 20;
                spriteX.height = DIB_HEIGHT+1;
                ...
                spriteY = tableGroup.create(table.x + 165 + i * (DIB_WIDTH + DIB_SPASE), table.y + 64 + j * (DIB_HEIGHT + DIB_SPASE), 'cell_select');
                ...
                spriteXY = tableGroup.create(table.x + 157 + i * (DIB_WIDTH + DIB_SPASE), table.y + 64 + j * (DIB_HEIGHT + DIB_SPASE), 'cell_select');
        ...
        tableCell['zero'] = tableGroup.create(table.x + 165, table.y + 12, 'zero_cell_select');
        ...
        tableCell['zero'].width = 220;
        tableCell['zero'].height = 60;
        ...
        Dozen['one'] = tableGroup.create(table.x + 75, table.y + 72, 'cell_select');
        ...
        Dozen['two'] = tableGroup.create(table.x + 75, table.y + 292, 'cell_select');
        ...
        Dozen['three'] = tableGroup.create(table.x + 75, table.y + 510, 'cell_select');
        ...
        Dozen['three'].alpha = 0;
        Dozen['three'].width = 85;
        Dozen['three'].height = 220;
        Dozen['three'].first = 8;
        Dozen['three'].last = 12;
        ...
        Column['one'] = tableGroup.create(table.x + 166, table.y + 735, 'cell_select');
        ...
        Column['two'] = tableGroup.create(table.x + 240, table.y + 735, 'cell_select');
        ...
        Column['three'] = tableGroup.create(table.x + 314, table.y + 735, 'cell_select');
        ...
        Column['three'].width = 70;
        Column['three'].height = 60;
        ...
        Orphelins['low'] = tableGroup.create(table.x + 12, table.y + 70, 'cell_select');
        ...
        Orphelins['low'].width = 60;
        Orphelins['low'].height = 115;
        ...
        Orphelins['high'] = tableGroup.create(table.x + 12, table.y + 619, 'cell_select');
        ...
        Orphelins['high'].width = 60;
        Orphelins['high'].height = 113;
        ...
        Orphelins['even'] = tableGroup.create(table.x + 12, table.y + 181, 'cell_select');
        ...
        Orphelins['even'].width = 60;
        Orphelins['even'].height = 115;
        ...
        Orphelins['odd'] = tableGroup.create(table.x + 12, table.y + 510, 'cell_select');
        ...
        Orphelins['odd'].width = 60;
        Orphelins['odd'].height = 111;
        ...
        Orphelins['black'] = tableGroup.create(table.x + 11, table.y + 290, 'cell_select');
        ...
        Orphelins['red'] = tableGroup.create(table.x + 11, table.y + 402, 'cell_select');
        ...
        Neighbors['zero'] = tableGroup.create(130, 730, 'cell_select');
        Neighbors['zero'].name = 'zero';
        Neighbors['zero'].bet_name = 'zero';
        Neighbors['zero'].bet_type = 'straight';
        Neighbors['zero'].alpha = 0;
        Neighbors['zero'].width = 130;
        Neighbors['zero'].height = 55;        
        ...
        Neighbors['voisins'] = tableGroup.create(265, 730, 'cell_select');
        ...
        Neighbors['voisins'].width = 275;
        Neighbors['voisins'].height = 55;
        ...
        Neighbors['orphelins'] = tableGroup.create(548, 730, 'cell_select');
        ...
        Neighbors['orphelins'].width = 210;
        Neighbors['orphelins'].height = 55;
    ...
    showWheel: function () {
        wheelBg = this.add.sprite(58, 48, 'wheelBg');
        wheelBg.width = 1044;
        wheelBg.height = 525;
        ...
        wheel = this.add.sprite(570, 320, 'wheel');
        wheel.scale.set(0.7);
   ...
   makeBetobject: function (element) {
    ...
    showSettings: function (element) {
        ...
        if (!isModalShow) {
            ...
            var settingsBox = this.add.sprite(750, 440, 'settingsBox');
            settingsBox.height = 210;
            settingsBox.width = 340;
            settingsPopup.add(settingsBox);
            settingsPopup.y = 500;
            settingsPopup.alpha = 0;
            showTween=game.add.tween(settingsPopup).to({ y: 330 }, 200, Phaser.Easing.Linear.None, true);
            setTimeout(function () {
                game.add.tween(settingsPopup).to({ alpha: 1 }, 200, Phaser.Easing.Linear.None, true);
            }, 100);
            cancelBtn = this.add.button(1047, 440, 'closeBtn', this.closeSettingsPopup);
            var soundBtn = settingsPopup.create(1010, 495, 'checkBox', $.client.getMuteState() ? 1 : 0);
            ...
            var layoutBtn = settingsPopup.create(1010, 535, 'checkBox', 1);
            ...
            function switchLayout() {
                if (layoutBtn.enabled) {
                    ...
                    createCookie(params.gameId, "Client3", 30);
                    document.location.href = document.location.href.replace(/clients\/Client4/g, "clients/Client3");
                } else {
            ...
            function showQuailitySelector() {
                if (!qualitiesBox) {
                    ...
                    qualitiesBox = self.add.sprite(950, 508, 'settingsBox');
