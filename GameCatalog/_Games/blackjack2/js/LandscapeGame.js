...
var tableCell = {}, numberLbls = {}, BJLandscapeGame = {};
...
BJLandscapeGame.Boot = function(game) {
};
BJLandscapeGame.Boot.prototype = {
    init: function() {
...
BJLandscapeGame.Preloader = function(game) {
    this.background = null;
    this.ready = false;
};
BJLandscapeGame.Preloader.prototype = {
    preload: function() {
...
BJLandscapeGame.Game = function(game) {
};
BJLandscapeGame.Game.prototype = {
    stateBg: null,
    labels: {
        betAmount: {},
        userBalance: {},
    ...
    create: function() {
        ...
        gameFrame = self.add.sprite(0, 0, "landGameFrame");
        ...
        self.buttons.cashierBtn = self.add.button(gameFrameW - 65, gameFrameH - 60, "cashin", function() {
            $.client.cashier();
        }, self);
        ...
        this.dealerCardPlace = this.add.sprite(50, 200, "landDealerCardsPlace");
        ...
        this.tableCell = frameGroup.create(gameFrameW/2 - 45, 565, "landPlaceChips");
        this.tableCell.id = 0;
        ...
        this.stateBg = this.add.sprite(30, gameFrameH - 157, "statusBg", 2);
        this.stateBg.width = 460;
            ...
            if (this.chipCost.length > 0) {
                for (var a = 0; a < this.chipCost.length; a++) {
                    if (a === selectedChipId || a === 0) {
                        chipsEl = chipsGroup.create(gameFrameW - 491 + (a * 78), 834, "chips", a + 6);
                        selectedChip = { id: a, value: this.chipCost[a] };
                    } else {
                        chipsEl = chipsGroup.create(gameFrameW - 491 + (a * 78), 834, "chips", a);
                    }
                    chipsEl.posY = chipsEl.y;
                    chipsEl.chipValue = this.chipCost[a];
                    chipsEl.id = a;
                    chipsEl.scale.set(0.94);
                    ...
                    function(msg) {
                        if (msg.ResponseData.success) {
                            ...
                            for (var i = 0; i < userCards.length; i++) {
                                ...
                                GameData.userCards[0]["c1"] = self.createCard(self.getCards(userCards[0]), gameFrameW - 410, 200);
                ...
                function(msg) {
                    ...
                    if (msg.ResponseData.success) {
                        ...
                        tween = self.add.tween(GameData.userCards[1]["c1"]).to({
                                x: GameData.userCards[1]["c1"].x + GameData.userCards[1]["c1"].width,
    ...
    showLimits: function() {
        ...
        if (!GameData.isModalShow) {
            if (GameData.selectedLimitArray.length != 0) {
                ...
                limitBox = this.add.sprite(480, 250, "limitsBg");
                ...
                if ($.client.UserData.Features && $.client.UserData.Features.rules) {
                    var rulesBtn = this.add.button(900, 260, "btnBg", function() {
                        $.client.showRules();
                    }, this);
                    rulesBtn.height = 40;
    ...
    showHistory: function(element) {
        ...
        if (!GameData.isModalShow) {
            ...
            historyBox = this.add.sprite(660, 250, "historyBg");
