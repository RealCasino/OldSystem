function CGame(oData) {
  ...
  this.changeCoinBet = function () {
    ...
    var iNewTotalBet;
    var maxBet = MAX_BET / _iLastLineActive;
  ...
  this.onMaxBet = function(){
    var iNewBet = MAX_BET / NUM_PAYLINES;
    _iLastLineActive = NUM_PAYLINES;
  ...
  this.onSpin = function () {
    ...
    $.client.sendPost(JSON.stringify({type: "spin", totalBet: _iTotBet}), function(msg) {
      console.log('spin_msg', msg);
