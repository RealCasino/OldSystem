...
var jsmpeg = window.jsmpeg = function( url, opts ) {
    ...
    else if (url instanceof String)
    {
        ...
        this.initCustomSource(url);
	}
};

// ----------------------------------------------------------------------------
// Streaming from custom source

jsmpeg.prototype.initCustomSource = function (config) {
...
jsmpeg.prototype.receiveCustomMessage = function (data) {
